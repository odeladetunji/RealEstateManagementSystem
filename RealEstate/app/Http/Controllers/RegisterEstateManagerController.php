...
class RegisterEstateManagerController extends BaseController
{
    //use AuthorizesRequests, DispatchesJobs, ValidatesRequests;
public function renderTheView($theRandomNumber){
	        return view('interface')->with('identity', $theRandomNumber);
	        //return redirect()->route('theInterface');
}
...
public function insertToDatabase($username, $password, $theRandomNumber){
            ...
            $this->renderTheView($theRandomNumber);
}
...
public function register(Request $request)
    {
    	 ...
    	 $theRandomNumber = $this->randomStringGenerator($username, $password);
